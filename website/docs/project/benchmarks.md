...
1. Use the script or contract in [`workload/README.md`](https://github.com/zrougamed/nyxd/blob/main/benchmarks/workload/README.md) (e.g. pull fixed image tag → run container with fixed flags → warm-up → measured phase).
...
Copy [`TEMPLATE.md`](https://github.com/zrougamed/nyxd/blob/main/benchmarks/TEMPLATE.md) into `results/YYYY-MM-DD-run-N.md` and fill after each trial.
...
- [QEMU Alpine](/docs/operations/qemu-alpine) — booting Alpine 3.23 under QEMU for nyxd experiments.
- [Usage](/docs/getting-started/usage) — `nyx` commands used in the nyxd column.
