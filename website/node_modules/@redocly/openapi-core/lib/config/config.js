            ...
            if (plugin.typeExtension !== undefined) {
                switch (version) {
                    ...
                    case 'overlay1':
                        ...
                        break;
                    case 'openrpc1':
                        if (!plugin.typeExtension.openrpc1)
                            continue;
    ...
    getRulesForSpecVersion(version) {
        switch (version) {
            ...
            case 'openrpc1':
                // eslint-disable-next-line no-case-declarations
                const openrpc1Rules = [];
                this.plugins.forEach((p) => p.preprocessors?.openrpc1 && openrpc1Rules.push(p.preprocessors.openrpc1));
                this.plugins.forEach((p) => p.rules?.openrpc1 && openrpc1Rules.push(p.rules.openrpc1));
                this.plugins.forEach((p) => p.decorators?.openrpc1 && openrpc1Rules.push(p.decorators.openrpc1));
