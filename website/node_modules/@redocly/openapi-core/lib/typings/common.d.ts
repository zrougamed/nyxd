...
export type OASStatsName = 'operations' | 'refs' | 'tags' | 'externalDocs' | 'pathItems' | 'links' | 'schemas' | 'webhooks' | 'parameters';
export type AsyncAPIStatsName = 'operations' | 'refs' | 'tags' | 'externalDocs' | 'channels' | 'schemas' | 'parameters';
