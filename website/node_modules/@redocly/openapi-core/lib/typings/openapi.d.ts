...
export interface Oas3PathItem<T extends Oas3Schema | Oas3_1Schema = Oas3Schema | Oas3_1Schema> {
    ...
    additionalOperations?: {
        [name: string]: Referenced<Oas3Operation<T>>;
    };
    servers?: Oas3Server[];
...
export interface Oas3MediaType<T extends Oas3Schema | Oas3_1Schema = Oas3Schema | Oas3_1Schema> {
    ...
    itemSchema?: Referenced<T>;
    prefixEncoding?: Oas3Encoding<T>[];
    itemEncoding?: Referenced<Oas3Encoding<T>>;
}
...
export type Oas3ParameterLocation = 'query' | 'querystring' | 'header' | 'path' | 'cookie';
...
export interface Oas3_2Components extends Oas3_1Components {
    mediaTypes?: {
        [name: string]: Referenced<Oas3MediaType<Oas3_1Schema>>;
    };
}
