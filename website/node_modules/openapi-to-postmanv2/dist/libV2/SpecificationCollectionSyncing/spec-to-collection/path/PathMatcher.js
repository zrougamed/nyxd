 ...
 */
function isParameterComponent(component) {
    if (!component) {
        return false;
    }
 ...
 */
function matchIdentifiers(identifier1, identifier2) {
    if (!identifier1 || !identifier2) {
        return false;
    }
    const components1 = identifier1.split('/'), components2 = identifier2.split('/');
    if (components1.length !== components2.length) {
        return false;
    }
    for (let i = 0; i < components1.length; i++) {
        const comp1 = components1[i], comp2 = components2[i], isParam1 = isParameterComponent(comp1), isParam2 = isParameterComponent(comp2);
